...
bool SoundClass::InitializeBGM(HWND hwnd)
{
	bool result;
	...
	char BGM[255] = "../Engine/data/Sound/BGM.wav";
	// Load a wave audio file onto a secondary buffer.
	result = LoadWaveFile(BGM, &m_secondaryBuffer1);
	if (!result)
	{
		return false;
	}
...
void SoundClass::SetVolume(LONG volume)
{
	m_Volume += volume;
	...
	m_secondaryBuffer1->SetVolume(m_Volume);
}

bool SoundClass::StopSound()
{
	HRESULT result;
