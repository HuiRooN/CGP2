...
bool LightShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix,
	...
	D3DXVECTOR4 pointDiffuseColor[], D3DXVECTOR4 lightPosition[])
{
	bool result;
...
void LightShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, const wchar_t* shaderFilename)
{
	char* compileErrors;
...
bool LightShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix,
	...
	float specularPower, D3DXVECTOR4 pointDiffuseColor[], D3DXVECTOR4 lightPosition[])
{
	HRESULT result;
	...
	dataPtr4->ambientColor = ambientColor;
	...
	dataPtr5->pointDiffuseColor[0] = pointDiffuseColor[0];
	dataPtr5->pointDiffuseColor[1] = pointDiffuseColor[1];
	dataPtr5->pointDiffuseColor[2] = pointDiffuseColor[2];
