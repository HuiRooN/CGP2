...
bool FontClass::Initialize(ID3D11Device* device, const char* fontFilename, const wchar_t* textureFilename)
{
	bool result;
...
bool FontClass::LoadTexture(ID3D11Device* device, const wchar_t* filename)
{
	bool result;
